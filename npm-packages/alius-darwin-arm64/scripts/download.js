#!/usr/bin/env node
/**
 * Download script for @alius-tech/alius-darwin-arm64
...
const ARTIFACT = pkg.binary.artifact || 'alius-macos-arm64.tar.gz';
...
async function install() {
  ...
  console.log(`Platform: macOS Apple Silicon (ARM64)`);
