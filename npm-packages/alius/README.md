...
[![npm version](https://img.shields.io/npm/v/@alius/alius.svg)](https://www.npmjs.com/package/@alius/alius)
...
npm install -g @alius/alius

# Or using yarn
yarn global add @alius/alius

# Or using pnpm
pnpm add -g @alius/alius
```
...
|----------|-------------|---------|
| macOS | Intel x64 | `@alius/alius-darwin-x64` |
| macOS | Apple Silicon arm64 | `@alius/alius-darwin-arm64` |
| Linux | x64 | `@alius/alius-linux-x64` |
| Linux | arm64 | `@alius/alius-linux-arm64` |
| Windows | x64 | `@alius/alius-win32-x64` |
| Windows | arm64 | `@alius/alius-win32-arm64` |
